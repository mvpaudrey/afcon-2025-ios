                ...
                Rectangle()
                    .fill(LinearGradient(
                        gradient: Gradient(colors: [
                            Color(config.accentColorName).opacity(0.1),
                            Color(config.secondaryColorName).opacity(0.1)
                        ]),
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            .padding(.vertical, 6)
                            .background(Color(config.accentColorName))
            ...
            VStack(alignment: .leading, spacing: 4) {
                HStack {
                    ...
                    Text(venue.capacity)
                        ...
                        .padding(.vertical, 2)
                        .background(Color(config.secondaryColorName).opacity(0.1))
                        .foregroundColor(Color(config.secondaryColorName))
                        .cornerRadius(4)
                        .overlay(
                            RoundedRectangle(cornerRadius: 4)
                                .stroke(Color(config.secondaryColorName), lineWidth: 1)
                        )
                }
                        ...
                        Text(attraction)
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 3)
                                    .stroke(Color(config.secondaryColorName), lineWidth: 0.5)
                            )
                    }
                }
            }
...
public struct Venue {
    ...
    public let nearbyAttractions: [String]
    public let contact: String
    public let website: String

    public init(id: Int, name: String, city: String, capacity: String, rating: Double, coordinates: String, description: String, facilities: [String], nearbyAttractions: [String], contact: String, website: String) {
        self.id = id
        self.name = name
        self.city = city
        ...
        self.nearbyAttractions = nearbyAttractions
