...
public struct LiveActivityDiagnosticsView: View {
...
public struct StatusCard: View {
    ...
    public init(title: String, status: Bool, icon: String) {
        self.title = title
        self.status = status
        self.icon = icon
    }
...
public struct ActivityRow: View {
    public let activity: ActivityKit.Activity<LiveScoreActivityAttributes>

    public init(activity: ActivityKit.Activity<LiveScoreActivityAttributes>) {
...
public struct TroubleshootingTip: View {
    public let icon: String
    public let title: String
