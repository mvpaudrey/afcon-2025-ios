...
public struct FavoriteTeamManagementView: View {
    @Environment(\.modelContext) private var modelContext
            ...
            ScrollView {
                LazyVGrid(columns: columns, spacing: 16) {
                    ForEach(config.availableTeams.sorted {
                        ...
                        SettingsTeamCardView(team: team, isSelected: selectedTeams.contains(team))
                            .onTapGesture {
...
// MARK: - SettingsTeamCardView (reusable, renamed to avoid conflict with OnboardingView's private TeamCardView)

private struct SettingsTeamCardView: View {
