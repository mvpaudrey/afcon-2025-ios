...
public struct FixturesListView: View {
...
public struct SwiftDataFixtureCard: View {
            ...
            HStack(alignment: .center, spacing: 20) {
                ...
                VStack(spacing: 8) {
                    ...
                    Text(fixture.homeTeamName)
                        ...
                        .foregroundColor(fixture.homeTeamWinner ? Color(config.accentColorName) : .primary)
                        .lineLimit(2)
                ...
                VStack(spacing: 8) {
                    ...
                    Text(fixture.awayTeamName)
                        ...
                        .foregroundColor(fixture.awayTeamWinner ? Color(config.secondaryColorName) : .primary)
                        .lineLimit(2)
                        .minimumScaleFactor(0.8)
                }
                .frame(maxWidth: .infinity)
    ...
    private func teamIcon(_ teamName: String) -> some View {
        ZStack {
            Circle()
                .fill(
                    LinearGradient(
                        colors: [Color(config.accentColorName).opacity(0.8), Color(config.secondaryColorName).opacity(0.8)],
