...
public struct QuickStatsBarLive: View {
    @Bindable public var liveScoresViewModel: LiveScoresViewModel
    ...
    public init(liveScoresViewModel: LiveScoresViewModel) {
        self.liveScoresViewModel = liveScoresViewModel
    }
