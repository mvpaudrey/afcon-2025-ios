...
public final class AppSettings: @unchecked Sendable {
    ...
    public var selectedFavoriteTeamIds: [Int] {
        get {
    ...
    public var lastDeviceToken: String? {
        get {
    ...
    public var lastFixturesSyncAt: Date? {
        get {
    ...
    public var hasCustomLanguage: Bool {
