...
public class MockDataProvider {
    nonisolated(unsafe) public static let shared = MockDataProvider()
    ...
    public func generateMockMatches(leagueID: Int32, season: Int32) -> [MockMatch] {
        switch leagueID {
    ...
    public func createLiveMatchUpdate(from mock: MockMatch) -> Afcon_LiveMatchUpdate {
    ...
    public func createGoalEvent(fixtureID: Int32, team: String, player: String, minute: Int32) -> Afcon_LiveMatchUpdate {
        var update = Afcon_LiveMatchUpdate()
...
public struct MockEvent {
    ...
    public let type: String  // Goal, Card, subst, var
    public let team: String
    public var player: String?
    public var playerOut: String?  // For substitutions
    public var playerIn: String?   // For substitutions
    public let detail: String

    public init(minute: Int32, type: String, team: String, player: String? = nil, playerOut: String? = nil, playerIn: String? = nil, detail: String) {
        self.minute = minute
        self.type = type
        self.team = team
        self.player = player
