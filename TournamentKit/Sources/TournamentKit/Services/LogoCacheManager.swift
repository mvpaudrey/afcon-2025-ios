...
public final class LogoCacheManager {
    nonisolated(unsafe) public static let shared = LogoCacheManager()
    ...
    private init() {
        let appGroupId = TournamentConfigStore.current.appGroupIdentifier
    ...
    public func cacheLogoIfNeeded(from urlString: String?) async -> String? {
    ...
    public func cachedLogoPath(for urlString: String?) -> String? {
    ...
    public func resolvePath(for storedPath: String?) -> String? {
