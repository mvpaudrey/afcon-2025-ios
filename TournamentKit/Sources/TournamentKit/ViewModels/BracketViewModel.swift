...
@Observable
public class BracketViewModel: @unchecked Sendable {
    nonisolated(unsafe) public static let shared = BracketViewModel()

    public var isLoading = false
    public var errorMessage: String?
    public var bracketMatches: BracketMatches?
    public var selectedRound: BracketRound = .roundOf16
    public var hasInitializedSelectedRound = false
    ...
    @MainActor
    public func loadBracketData() async {
        isLoading = true
        errorMessage = nil

        do {
            let response = try await service.getStandings()
    ...
    @MainActor
    public func syncKnockoutFixturesForPastDates() async {
    ...
    @MainActor
    public func refreshBracketFromFixtures() {
    ...
    public func getTeam(group: String, position: Int) -> String {
    ...
    public func getThirdByRank(_ rank: Int) -> String {
    ...
    public func getRoundOf16Matches() -> [BracketMatch] {
