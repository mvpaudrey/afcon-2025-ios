...
@Observable
@MainActor
open class LiveScoresViewModel {
    private let service = TournamentServiceWrapper.shared
    private var dataManager: FixtureDataManager?
    private let modelContext: ModelContext?

    public var liveMatches: [Game] = []
    public var upcomingMatches: [Game] = []
    public var finishedMatches: [Game] = []
    public var fixtureEvents: [Int: [Afcon_FixtureEvent]] = [:]
    ...
    public var secondsUntilNextUpdate: Int = 0
    ...
    public func isFavoriteTeamMatch(_ game: Game) -> Bool {
    ...
    public var upcomingTodayMatches: [Game] {
