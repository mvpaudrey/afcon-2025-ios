...
public class GroupsViewModel {
    ...
    public var thirdPlaceRanking: Group?
    ...
    public func loadStandings() async {
        ...
        do {
            ...
            do {
                let apiResponse = try await service.getStandings()
    ...
    public func getBestThirds(count: Int = 4) -> [Team] {
    ...
    public func getThirdByRank(_ rank: Int) -> Team? {
